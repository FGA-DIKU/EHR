...
class OutcomeMaker:
    ...
    def __call__(
        ...
        for outcome, attrs in self.outcomes.items():
            ...
            timestamps['TIMESTAMP'] = Utilities.get_abspos_from_origin_point(timestamps['TIMESTAMP'], self.origin_point) 
    ...
    def match_concepts(self, concepts_plus: pd.DataFrame, types: List[List], 
        ...
        col_booleans = get_col_booleans(concepts_plus, types, matches, 
...
class OutcomeHandler:
    ...
    def __init__(self, 
        ...
        self.exclude_pre_followup_outcome_patients = exclude_pre_followup_outcome_patients
    ...
    def handle(
        ...
        if self.select_patient_group:
            data = self.select_exposed_or_unexposed_patients(data, exposed_patients, self.select_patient_group)
